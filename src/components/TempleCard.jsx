    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 w-full">
              <div className="max-w-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-[#ff6b6b] hover:bg-[#ff5252] text-white font-bold py-3 px-8 rounded-full transition duration-300">
                    Book Your Journey
                  </button>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                3-day adventure through scenic mountain routes
              </p>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
            <div className="h-64 bg-[#f8f9fa]">
              <i className="fas fa-city text-6xl text-[#ff6b6b] flex items-center justify-center h-full"></i>
            </div>
            <div className="p-6">
              <h3 className="text-xl font-semibold font-roboto mb-2">
                City Explorer
              ...
              <p className="text-gray-600">
                2-day tour of historic city centers
              </p>
              <div className="mt-4 flex justify-between items-center">
                <span className="text-[#ff6b6b] font-semibold">From $199</span>
                <button className="text-[#ff6b6b] font-semibold hover:text-[#ff5252]">
                  Learn More →
                </button>
              </div>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
            <div className="h-64 bg-[#f8f9fa]">
              <i className="fas fa-umbrella-beach text-6xl text-[#ff6b6b] flex items-center justify-center h-full"></i>
            </div>
            <div className="p-6">
              <h3 className="text-xl font-semibold font-roboto mb-2">
                Coastal Journey
              ...
              <p className="text-gray-600">
                4-day coastal route with beach stops
              </p>
              <div className="mt-4 flex justify-between items-center">
                <span className="text-[#ff6b6b] font-semibold">From $399</span>
                <button className="text-[#ff6b6b] font-semibold hover:text-[#ff5252]">
                  Learn More →
                </button>
              </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div className="p-6">
              <i className="fas fa-shield-alt text-4xl text-[#ff6b6b] mb-4"></i>
              <h3 className="text-xl font-semibold font-roboto mb-2">
                Safety First
              </h3>
              <p className="text-gray-600">
            ...
            <div className="p-6">
              <i className="fas fa-clock text-4xl text-[#ff6b6b] mb-4"></i>
              <h3 className="text-xl font-semibold font-roboto mb-2">
                Punctual Service
              </h3>
              <p className="text-gray-600">
            ...
            <div className="p-6">
              <i className="fas fa-couch text-4xl text-[#ff6b6b] mb-4"></i>
              <h3 className="text-xl font-semibold font-roboto mb-2">
                Comfort
              </h3>
              <p className="text-gray-600">
            ...
            <div className="p-6">
              <i className="fas fa-headset text-4xl text-[#ff6b6b] mb-4"></i>
              <h3 className="text-xl font-semibold font-roboto mb-2">
                24/7 Support
              </h3>
